...
const Login = () => {
  ...
  return (
    <div className='min-h-[90vh] flex flex-col lg:flex-row items-center justify-center lg:justify-around bg-cover bg-center py-10 px-6 lg:px-16 xl:px-24' 
      ...
      <div className='w-full max-w-[450px] p-6 md:p-8 mb-12 lg:mb-0 order-2 lg:order-1'>
         ...
         <form onSubmit={handleSubmit}>
            ...
            <div className='flex justify-between items-center mt-6 mb-6'>
                ...
                <span className='text-white text-sm hover:text-blue-500 cursor-pointer'>Forgot Password?</span>
            </div>
            <style>
                {`
            ...
            <button 
                ...
                style={{
                    background: 'linear-gradient(90deg, #858dff, #ff98e2, #7adb78, #ff776f, #ffc876, #ac6aff)',
            ...
            <div className='text-center mt-6'>
                <span className='text-white text-sm'>New Here? <Link to='/register' className='text-blue-500 hover:underline'>Create an Account</Link> </span>
            </div>
        </form>
      </div>
